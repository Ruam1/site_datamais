...
import  { initPixelSejaParceiro }  from '../../../services/facebookPixel';
...
const BodySejaParceiro = () =>{
  useEffect(() => {
    initPixelConvTrkr();
    logPixelPageView();
    initPixelSejaParceiro();
    }, [])
    ...
    function getInfoFormResume(resume){
        ...
        let empresaInput = document.querySelector("#inputEmpresa");
...
... <p>Informações Adicionais: ${info}</p>`;
        ...
        const formClient = {
          ...
          "subject": "Formulário de seja parceiro do site",
          "msg": encodeMsg,
    ...
    return(
        <StyledBodyOneTC resumeConfirm={resumeConfirm} >
             <div className='infoOne'>
                <h1><i>Torne-se um <b>parceiro!</b></i></h1>
                <div className='h1Subli' />
                <p><b>Deseja revender o Sistema Datamais? Entre em contato pelo formulário abaixo e fale conosco.</b></p>
                <div className='divForm'>
                    <form>
                        ...
                        <label>Empresa</label>
                        <input id="inputEmpresa" placeholder=''/>
                        <label >E-mail</label>
                        <input id="inputemail" />
                        ...
                        <div className='formTwo'>   
                            ...
                            <input id="inputcity"/>
                            <label>Breve descrição da área de atuação</label>
...
export default BodySejaParceiro;